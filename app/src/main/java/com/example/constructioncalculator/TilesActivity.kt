...
class TilesActivity : AppCompatActivity() {
    ...
    companion object {
        const val PREFS_NAME  = "TilesPrices"
        const val KEY_TILE    = "tile_price"
        const val KEY_LABOR   = "labor_price"
    }

    data class TilePreset(
        val name: String, val lengthCm: Double,
        val widthCm: Double, val wastePct: Double, val drawableId: Int
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val etTilePrice  = findViewById<EditText>(R.id.etTilePrice)
        ...
        etTilePrice.setText(prefs.getString(KEY_TILE, ""))
        ...
        spType.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(p: AdapterView<*>?, v: View?, pos: Int, id: Long) {
                ...
                if (preset.lengthCm > 0) {
                    ...
                    etTL.isEnabled = false; etTW.isEnabled = false
                } else {
        ...
        btnCalc.setOnClickListener {
            // حفظ الأسعار
            prefs.edit()
                .putString(KEY_TILE,  etTilePrice.text.toString())
            ...
            Toast.makeText(this, "⚠️ Please fill all fields with valid values", Toast.LENGTH_SHORT).show()
            ...
            val tilePrice  = etTilePrice.text.toString().toDoubleOrNull()  ?: 0.0
            ...
            // حساب التكلفة
            val tileCost  = totalTiles * tilePrice
            val laborCost = floorArea  * laborPrice
            val totalCost = tileCost + laborCost
            ...
            sb.append("    A = ${floorL.f(2)} × ${floorW.f(2)} = ${floorArea.f(4)} m²\n")
            sb.append("    $roomCheck\n")
            sb.append("━━━━━━━━━━━━━━━━━━━━━━━━━━\n")
            sb.append("🧩  Step 2 — Tile Area\n")
            sb.append("    ${tileL.toInt()} cm ÷ 100 = ${tileLm.f(2)} m\n")
            sb.append("    ${tileW.toInt()} cm ÷ 100 = ${tileWm.f(2)} m\n")
            sb.append("    Tile area = ${tileAreaM2.f(4)} m²\n")
            sb.append("━━━━━━━━━━━━━━━━━━━━━━━━━━\n")
            sb.append("🔢  Step 3 — Base Count\n")
            sb.append("    N = ${floorArea.f(4)} ÷ ${tileAreaM2.f(4)} = ${baseTiles.f(2)}\n")
            sb.append("    → ${ceil(baseTiles).toInt()} tiles\n")
            sb.append("━━━━━━━━━━━━━━━━━━━━━━━━━━\n")
            sb.append("♻️  Step 4 — Waste\n")
            ...
            sb.append("    Total = ${ceil(baseTiles).toInt()} × ${(1.0 + totalWastePct).f(2)} = $totalTiles tiles\n")
            sb.append("━━━━━━━━━━━━━━━━━━━━━━━━━━\n")
            sb.append("📊  Step 5 — Layout\n")
            sb.append("    Along L : $tilesAlongL tiles\n")
            sb.append("    Along W : $tilesAlongW tiles\n")
            sb.append("━━━━━━━━━━━━━━━━━━━━━━━━━━\n")
            sb.append("📦  Step 6 — Boxes\n")
            sb.append("    Tiles/box : $tilesPerBox\n")
            sb.append("    Boxes     : ceil($totalTiles ÷ $tilesPerBox) = $boxesNeeded boxes\n")
            sb.append("━━━━━━━━━━━━━━━━━━━━━━━━━━\n")
            sb.append("✅  TOTAL TILES = $totalTiles tiles\n")
            sb.append("📦  TOTAL BOXES = $boxesNeeded boxes\n")

            // عرض التكلفة
            if (tilePrice > 0 || laborPrice > 0) {
                sb.append("━━━━━━━━━━━━━━━━━━━━━━━━━━\n")
                sb.append("💰  Cost Estimation\n")
                if (tilePrice > 0)
                    sb.append("    🧱 Tiles : $totalTiles × ${tilePrice.f(2)} = ${tileCost.f(2)}\n")
                if (laborPrice > 0)
                    sb.append("    👷 Labor : ${floorArea.f(4)} m² × ${laborPrice.f(2)} = ${laborCost.f(2)}\n")
                sb.append("    ✅ Total Cost = ${totalCost.f(2)}\n")
            }
